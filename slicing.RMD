...
```{r}
#Pulling all values from just the MPG column
df[,1]
...
df[c('Valiant','Duster 360','Merc 240D'),]
...
```{r}
#Answer 3
df[c('Datsun 710','Valiant','Lotus Europa'),c('mpg','hp','gear')]
```

```{r}
#Answer 4
df[c(1,nrow(df)),c(1,ncol(df))]
```